...
#include <iostream>
#include </home/christina/CHaarFeature.h>
#include <vector>
#include <opencv/cv.h>
...
CHaarFeature::CHaarFeature(int r1x1, int r1x2, int r1y1, int r1y2, int r2x1, int r2x2, int r2y1, int r2y2, int r3x1, int r3x2, int r3y1, int r3y2, int r4x1, int r4x2, int r4y1, int r4y2, double r1weight, double r2weight, double r3weight, double r4weight){
	this->nr_reg = 4;
	this->weights = vector<double>(4);
	this->weights[0] = r1weight;
	this->weights[1] = r2weight;
	this->weights[2] = r3weight;
        this->weights[3] = r3weight;
...
//^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ sherly removed from original code as it is not used anywhere ^^^^^^^^^^^^^^^^^^^^^^^^^^//
